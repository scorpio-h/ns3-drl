...
class CriticNetwork(object):
    def __init__(self, sess, DDPG_config):
        ...
        self.action_size = DDPG_config['ACTION_DIM']   
        self.state_size = DDPG_config['STATE_DIM']
        ...
        self.model, self.action, self.state = self.create_critic_network(self.state_size, self.action_size)
        self.target_model, self.target_action, self.target_state = self.create_critic_network(self.state_size, self.action_size)
